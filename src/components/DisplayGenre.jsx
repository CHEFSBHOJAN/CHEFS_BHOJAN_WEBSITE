...
function DisplayGenre() {
    ...
    const getItemsByGenre = (genre) => {
        const normalizedGenre = genre.toLowerCase();  // Normalize the genre
        let filteredItems = []
    ...
    return (
        <div className='mb-80'>
            ...
            <div className="pt-14 flex flex-col items-center justify-center overflow-x-hidden">
                <h1 className="mb-4 px-5 py-3 bg-amber-400 rounded-full font-poppins text-2xl text-white font-semibold ">
