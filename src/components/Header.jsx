                    ...
                    <div className="flex flex-col md:flex-row gap-5">
                        <div className="flex flex-col w-full md:w-6/12">
                            <div className="flex flex-col text-white">
                                ...
                                <h1 className="mt-12 md:mt-24 text-5xl md:text-8xl font-Heavitas text-red-800 leading-none">
                                    LOKENDRA OLI
                                </h1>
                                <h2 className="self-center font-sans mt-8 md:mt-12 text-2xl md:text-3xl leading-8 font-bold drop-shadow-3xl text-center">
